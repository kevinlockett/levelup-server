...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(max_length=50, verbose_name='game type')),
            ],
        ),
        migrations.CreateModel(
            name='Gamer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maker', models.CharField(max_length=100, verbose_name='game maker')),
                ('number_of_players', models.IntegerField()),
                ('skill_level', models.IntegerField()),
                ('game_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='levelupapi.gametype', verbose_name='the related game type')),
                ('gamer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='levelupapi.gamer', verbose_name='gamer associated with this game')),
            ],
        ),
        migrations.CreateModel(
            name='EventGamer',
